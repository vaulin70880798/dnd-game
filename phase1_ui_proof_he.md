...
## עדכון קריטי (תיקון סטיית Flow)

- בוטלה פונקציונליות **"יצירת גיבור"** במסך Home.
- לחיצה על קמפיין אינה פותחת popup קטן — נפתח **עמוד נחיתה מלא לקמפיין** (Full Landing Page):
  - Hero Header עם קאבר קולנועי גדול.
  - לור מפורט + Hook + מבנה 3 מערכות.
  - גריד של 4 גיבורים מוכנים מראש.
  - בחירת גיבור חושפת **סצנת פתיחה ייחודית** + סוד אפל.
  - כפתור התחלה כגיבור הנבחר.
